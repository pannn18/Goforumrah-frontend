...
const ManageList = () => {
  const manages = [
    ...
    { type: Services.Hotel, image: Images.Placeholder, orderId: '123456789', name: { name: 'Sheraton Makkah Jabal Al Kaaba' }, status: 'confirm', location: 'Hotel in Ayjad, Makkah', desc: { date: 'Sun, 27 Oct 2022', people: '2 Guest', duration: '2 Guest' }, linkURL: '#' },
