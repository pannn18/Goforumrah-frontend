        ...
        <div className="modal-dialog cancelation__modal">
          <div className="modal-content cancelation__modal-body">
            ...
            <div className="cancelation__modal-footer">
              ...
              <a type='button' onClick={() => router.push('/cancelation/flight/done/')} className="btn btn-lg btn-success cancelation__modal-button" data-bs-dismiss="modal">Request to cancel</a>
            </div>            
          </div>
        </div>
      </div>
