      ...
      <div className="cancelation__confirmation">
        ...
        <div className="cancelation__confirmation-wrapper">
          ...
          <div className="cancelation__confirmation-preview-text">
            <p className="cancelation__confirmation-preview-name">Sheraton Makkah Jabal Al Kaaba Hotel</p>
            <p className="cancelation__confirmation-preview-detail">1x Twin Room (Standard)</p>
