...
const BreadCrumb = () => {
  return (
    <div className="cancelation__breadcrumb">
      ...
      <p>/</p>      
      <Link className="cancelation__breadcrumb--link" href="#">Mercedez-Benz E-Class Estate</Link>
      <p>/</p>      
        ...
        <div className="cancelation__confirm-preview">
          ...
          <div className="cancelation__confirm-wrapper">
            ...
            <div className="cancelation__confirm-preview-text">
              <p className="cancelation__confirm-preview-name">Mercedez-Benz E-Class Estate</p>
        ...
        <div className="modal-dialog cancelation__modal">
          <div className="modal-content cancelation__modal-body">
            ...
            <div className="cancelation__modal-footer">
              ...
              <a type='button' onClick={() => router.push('/cancelation/car/done/')} className="btn btn-lg btn-success cancelation__modal-button" data-bs-dismiss="modal">Request to cancel</a>
            </div>            
          </div>
        </div>
      </div>
