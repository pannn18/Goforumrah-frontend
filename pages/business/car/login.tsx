...
import passIcon from '@/assets/images/icon_eye_pass.svg'
  ...
  const onSubmit = async (values) => {
    ...
    if (activeStep === 'password' && ((!isValid && !errors.password && !values.password) || (isValid))) {
      ...
      if (ok && status == 200) {
        ...
        document.location.href = '/business/car'
      } else {
          ...
          <div className='row h-100'>
            <div className='col-lg-6 col-lg-offset-6 col-md-12 signup-business__left'>
              <div className='signup-business__left-content'>
                ...
                <form className='signup-business__form' onSubmit={handleSubmit(onSubmit, onSubmit)}>
                  ...
                  {activeStep === 'password' && (
                    <>
                      ...
                      <p className='signup-business__single-link' style={{ marginTop: 24 }}><Link href='/business/car/forgot-password'>Forgot Password?</Link></p>
                    </>
                  )}
                ...
                {activeStep === 'email' && (
                  <Link href='/business/car/signup' className='btn goform-button goform-button--outline-green signup-business__form-button'>Create your partner account</Link>
                )}
